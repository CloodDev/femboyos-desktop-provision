...
class UbuntuBootstrapLocalizationsMl extends UbuntuBootstrapLocalizations {
  ...
  String windowTitle(String RELEASE) {
    return 'FemboyOS ഇൻസ്റ്റാൾ ചെയ്യുക';
  }
  ...
  String tryOption(String RELEASE) {
    return 'FemboyOS ഉപയോഗിച്ച് നോക്കുക';
  }

  @override
  String tryDescription(String RELEASE) {
    return 'നിങ്ങളുടെ കമ്പ്യൂട്ടറിൽ മാറ്റങ്ങളൊന്നും വരുത്താതെ തന്നെ നിങ്ങൾക്ക് FemboyOS പരീക്ഷിക്കാവുന്നതാണ്.';
  }
  ...
  String installDescription(String RELEASE) {
    return 'നിങ്ങളുടെ നിലവിലെ ഓപ്പറേറ്റിംഗ് സിസ്റ്റത്തിനൊപ്പം (അല്ലെങ്കിൽ പകരം) FemboyOS ഇൻസ്റ്റാൾ ചെയ്യുക. ഇത് അധിക സമയം എടുക്കാൻ പാടില്ലാത്തതാണ്.';
  }
  ...
  String installationTypeErase(String DISTRO) {
    return 'ഡിസ്ക് മായ്ച്ച് FemboyOS ഇൻസ്റ്റാൾ ചെയ്യുക';
  }
  ...
  String installationTypeManualInfo(String DISTRO) {
    return 'നിങ്ങൾക്ക് സ്വയം പാർട്ടീഷനുകൾ സൃഷ്ടിക്കുകയോ വലുപ്പം മാറ്റുകയോ ചെയ്യാം, അല്ലെങ്കിൽ FemboyOS-നായി ഒന്നിലധികം പാർട്ടീഷനുകൾ തിരഞ്ഞെടുക്കാം';
  }
