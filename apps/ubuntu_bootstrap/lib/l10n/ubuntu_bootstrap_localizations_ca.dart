...
class UbuntuBootstrapLocalizationsCa extends UbuntuBootstrapLocalizations {
  ...
  String windowTitle(String RELEASE) {
    return 'Instal·lació del sistema FemboyOS';
  }
  ...
  String tryOption(String RELEASE) {
    return 'Prova el sistema FemboyOS';
  }

  @override
  String tryDescription(String RELEASE) {
    return 'Podeu provar FemboyOS sense fer cap canvi al vostre ordinador.';
  }

  @override
  String installOption(String RELEASE) {
    return 'Instal·la el sistema FemboyOS';
  }

  @override
  String installDescription(String RELEASE) {
    return 'Instal·lar FemboyOS al costat (o en lloc de) del vostre sistema operatiu actual. Això no hauria de trigar massa.';
  }
