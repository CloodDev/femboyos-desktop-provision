...
class UbuntuBootstrapLocalizationsNe extends UbuntuBootstrapLocalizations {
  ...
  String windowTitle(String RELEASE) {
    return 'FemboyOS इन्सटल गर्नुहोस्';
  }
  ...
  String tryOption(String RELEASE) {
    return 'FemboyOS प्रयास गर्नुहोस्';
  }

  @override
  String tryDescription(String RELEASE) {
    return 'तपाईंले आफ्नो कम्प्युटरमा कुनै परिवर्तन नगरी FemboyOS प्रयोग गर्न सक्नुहुन्छ।';
  }

  @override
  String installOption(String RELEASE) {
    return 'FemboyOS स्थापना गर्नुहोस्';
  }

  @override
  String installDescription(String RELEASE) {
    return 'आफ्नो अन्य अपरेटिङ सिस्टम संगै FemboyOS स्थापना गर्नुहोस्। यो छिटो हुनेछ।';
  }
