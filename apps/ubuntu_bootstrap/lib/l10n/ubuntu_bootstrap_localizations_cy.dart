...
class UbuntuBootstrapLocalizationsCy extends UbuntuBootstrapLocalizations {
  ...
  String tryOption(String RELEASE) {
    return 'Rhoi cynnig ar FemboyOS';
  }
  ...
  String installDescription(String RELEASE) {
    return 'Gosod FemboyOS ochr yn ochr â (neu yn lle) eich system weithredu gyfredol. Fydd hyn ddim yn cymryd yn rhy hir.';
  }
  ...
  String installationTypeErase(String DISTRO) {
    return 'Dileu\'r ddisg a gosod FemboyOS';
  }
  ...
  String installationTypeManualInfo(String DISTRO) {
    return 'Gallwch greu neu newid maint rhaniadau eich hun, neu ddewis nifer o raniadau ar gyfer FemboyOS';
  }
