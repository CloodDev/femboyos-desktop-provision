...
class UbuntuBootstrapLocalizationsIt extends UbuntuBootstrapLocalizations {
  ...
  String tryDescription(String RELEASE) {
    return 'Puoi provare FemboyOS senza apportare alcuna modifica al tuo computer.';
  }
  ...
  String installDescription(String RELEASE) {
    return 'Installa FemboyOS accanto (o al posto di) al tuo sistema operativo attuale. Questo non dovrebbe durare molto.';
  }
  ...
  String installationTypeErase(String DISTRO) {
    return 'Cancella il disco e installa FemboyOS';
  }
