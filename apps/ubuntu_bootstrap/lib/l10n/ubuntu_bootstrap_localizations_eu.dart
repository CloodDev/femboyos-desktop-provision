...
class UbuntuBootstrapLocalizationsEu extends UbuntuBootstrapLocalizations {
  ...
  String tryOption(String RELEASE) {
    return 'FemboyOS probatu';
  }

  @override
  String tryDescription(String RELEASE) {
    return 'FemboyOS probatu dezakezu zure ordenagailuan aldaketarik egin gabe.';
  }
  ...
  String installDescription(String RELEASE) {
    return 'FemboyOS instalatu zure sistemaren ondoan (edo ordez). Ez du asko iraungo.';
  }
