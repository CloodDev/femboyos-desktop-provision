...
class UbuntuBootstrapLocalizationsAr extends UbuntuBootstrapLocalizations {
  ...
  String autoinstallHeader(String DISTRO) {
    return 'كيف تريد تنصيب FemboyOS؟';
  }
  ...
  String loadingPageTitle(String DISTRO) {
    return 'مرحبا بك في FemboyOS';
  }

  @override
  String loadingHeader(String DISTRO) {
    return 'يجري إعداد FemboyOS …';
  }
  ...
  String tryOrInstallTitle(String DISTRO) {
    return 'جرب او ثبت FemboyOS';
  }

  @override
  String tryOrInstallHeader(String DISTRO) {
    return 'ما الذي تريد فِعلَه بـ FemboyOS؟';
  }
  ...
  String tryDescription(String RELEASE) {
    return 'يمكنك تجربة FemboyOS بدون إجراء اي تغييرات لجهازك.';
  }
  ...
  String installDescription(String RELEASE) {
    return 'ثبت FemboyOS بجانب او بدلا من نظامك الحالي. لا ينبغي لهذا الإجراء اخذ الكثير من الوقت.';
  }
