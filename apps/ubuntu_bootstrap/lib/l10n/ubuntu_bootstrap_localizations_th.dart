...
class UbuntuBootstrapLocalizationsTh extends UbuntuBootstrapLocalizations {
  ...
  String tryOption(String RELEASE) {
    return 'ทดลอง FemboyOS';
  }

  @override
  String tryDescription(String RELEASE) {
    return 'คุณสามารถทดลองใช้ FemboyOS โดยไม่ทำการเปลี่ยนแปลงใดกับคอมพิวเตอร์ของคุณได้';
  }
  ...
  String installDescription(String RELEASE) {
    return 'ติดตั้ง FemboyOS ควบคู่ (หรือแทนที่) ระบบปฏิบัติการปัจจุบันของคุณ ซึ่งกระบวนการนี้จะใช้เวลาไม่นานมากนัก';
  }
